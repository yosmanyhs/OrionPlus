...
static const double fp_scale = 461168601.8427387904; // optimize to store this as it does not change
...
class Block 
{
    ...
    public:
        ...
        uint8_t  direction_bits;     // Direction for each axis in bit form, relative to the direction port's mask
